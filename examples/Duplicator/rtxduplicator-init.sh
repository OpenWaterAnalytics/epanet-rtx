...
# Default-Stop:      0 1 6
# Short-Description: RTX Timeseries Duplicator
# Description:       Provides timeseries duplication daemon
### END INIT INFO

# Author: Sam Hatchett <sam@citilogics.com>

# PATH should only include /usr/* if it runs after the mountnfs.sh script
PATH=/sbin:/usr/sbin:/bin:/usr/bin
DESC="RTX Timeseries Duplication"
NAME=rtxduplicator
DAEMON=/opt/rtx/$NAME
DAEMON_ARGS=""
...
if [ -r $DEFAULT ]; then
  source $DEFAULT # read in vars: RTX_OPTS = blah blah blah
fi
