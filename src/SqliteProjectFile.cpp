...
map<string, TimeSeries::sharedPointer> SqliteProjectFile::timeSeries() {
  
}

map<string, PointRecord::sharedPointer> SqliteProjectFile::pointRecords() {
  
}

map<string, Clock::sharedPointer> SqliteProjectFile::clocks() {
