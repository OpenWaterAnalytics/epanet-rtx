...
int     addcoord(char *);                 /* Adds coord to data base    */ //06/02.2010-woohn
...
int     getcoords(void);                  /* Gets coordinate data from list  */ //06.02.2010 woohn
...
int     coordata(void);                   /* Processes coordinate data       */ //06.02.2010
