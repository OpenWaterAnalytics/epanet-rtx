...
/* Allocate input buffer */
   ...
   /* Read each line from input file. */
      ...
      /* Check if max. length exceeded */
         ...
         {
            sprintf(Msg,ERR214,RptSectTxt[sect]);
            writeline(Msg);
            writeline(line);
            errsum++;
         }
...
*/
{
   ...
   /* Data in these sections are not used for any computations */
       case _COORDS:      return(coordata());	//06.02.2010 woohn 
...
//////////////////////////////////////////////////////////
// this function is added to get coordinates of nodes
// 06/02/2010 woohn
//////////////////////////////////////////////////////////
int     getcoords(void)
/*
